...
export default function AddRateModal({ targetSlug }: { targetSlug?: string }) {
  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          {/* Modal */}
          <div className="relative bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-gray-200 dark:border-zinc-800 w-full max-w-4xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
