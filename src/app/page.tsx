...
import { db } from "@/db";
import { rates, pageSettings, offshoreRates } from "@/db/schema";
          ...
          offshoreContent={
            dbOffshoreRates.length === 0 ? (
              <div className="py-20 w-full text-center flex flex-col items-center max-w-lg mx-auto animate-in zoom-in-95 mt-8 border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-2xl shadow-sm p-8 relative z-10">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-zinc-50 mb-3">Offshore rates unavailable</h3>
                <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                  These channels are currently restricted. Please contact your administrator to request a custom offshore profile assignment.
                </p>
              </div>
            ) : (
